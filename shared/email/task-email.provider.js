...
const DEFAULT_BASE_URL = process.env.FRONTEND_URL
...
class TaskEmailProvider {
  ...
  /**
   * Send email to notify assignee about task assignment.
   * @param {Object} payload
   * @param {string} payload.toEmail
   * @param {string} payload.assigneeName
   * @param {string} payload.assignerName
   * @param {string} payload.taskName
   * @param {string} payload.projectName
   * @param {number|undefined} payload.dueDate
